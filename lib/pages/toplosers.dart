  ...
  Widget build(BuildContext context) {
    return const Scaffold(
        ...
        body: SingleChildScrollView(
            child: Column(children: [Divider(), toplosertab(), loserinfo()])));
  }
}

// Top losers stock information table

class loserinfo extends StatefulWidget {
  ...
  @override
  State<loserinfo> createState() => _loserinfoState();
}

class _loserinfoState extends State<loserinfo> {
  void _reloadPage() {
    setState(() {
  ...
  GestureDetector addfavouritetoplosers(
...
class toplosertab extends StatelessWidget {
  const toplosertab({
    super.key,
  });
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(color: const Color(0xffBA2C2C), width: 2.0)),
            child: const Center(
              child: Text(
                'TOP LOSERS',
                style: TextStyle(
          ...
          Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(color: const Color(0xffBA2C2C), width: 3.0)),
                    ...
                    return Padding(
                      ...
                      child: Container(
                        ...
                        decoration: const BoxDecoration(
                            border: Border(
                          bottom:
                              BorderSide(width: 1, color: Color(0xffBA2C2C)),
                        )),
                        child: Row(
